const nameAndTitle = {
  ...
  intro: `<p>Hello and thank you for visiting!</p>
            ...
            <p>Currently, I'm a Data Designer and CCAI Developer working alongside rapidly growing technology companies that use Dialogflow CX, Python, and Google's Cloud Platform.</p>
            `,
};
